...
const jobs = [
    ...
    {id: '7', title: 'Vice Chancellor', salary: '$130,000/y', company: 'KA', location: 'Accra, Ghana', icon: require('../assets/Facebook2.png')},
    {id: '8', title: 'Pro Vice Chancellor', salary: '$124,000/y', company: 'EQ Corp', location: 'Kumasi, Ghana', icon: require('../assets/BurgerKing.png')},
    {id: '9', title: 'Dean', salary: '$100,000/y', company: 'JBL', location: 'New York City, US', icon: require('../assets/Beats.png')},
];
